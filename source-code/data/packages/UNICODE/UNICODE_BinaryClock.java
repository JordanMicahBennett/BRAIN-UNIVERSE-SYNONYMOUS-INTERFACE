...
{               
	...
	public void show ( )
	{
		...
		binaryClockDisplayComponent.setBounds ( ( ( ( int ) fileManager.getBufferDimensionFromFile ( ).getWidth ( ) / 2 ) - binaryClockDisplayComponent.getWidth ( ) / 2 ) + binaryClockdisplayComponentSurfaceVaccum, binaryClockDisplayComponent.getHeight ( ) + yDisplacementHelper, binaryClockDisplayComponent.getWidth ( ), binaryClockDisplayComponent.getHeight ( ) );
		binaryClockDisplayComponent.repaint ( );
	}
