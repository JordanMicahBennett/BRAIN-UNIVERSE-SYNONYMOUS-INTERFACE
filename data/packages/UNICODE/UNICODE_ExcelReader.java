...
public class UNICODE_ExcelReader
{
    ...
    public String createRowStringFromExcelData ( String filename, int current_sheet, int current_row, int num_rows, int num_columns )
    {
        //establish workbook
        ...
        for ( int rows = current_row; rows < num_rows; rows ++ )
